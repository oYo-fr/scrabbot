...
class AdvancedFeaturesTestSuite:
        ...
        test_results["language_statistics"] = {
            "french_stats": {
                ...
                "most_common_letters": sorted(
                    fr_stats.letter_frequency.items(),
                    key=lambda x: x[1],
                    reverse=True,
                )[:5],
            },
            "english_stats": {
                ...
                "most_common_letters": sorted(
                    en_stats.letter_frequency.items(),
                    key=lambda x: x[1],
                    reverse=True,
                )[:5],
            },
    ...
    def test_scrabble_strategy(self):
        ...
        game_state = {"score_difference": 10, "tiles_remaining": 30}
    ...
    def run_comprehensive_test(self):
        ...
        all_results["test_metadata"]["total_duration_seconds"] = round(
            all_results["test_metadata"]["end_time"] - all_results["test_metadata"]["start_time"],
            2,
        )
