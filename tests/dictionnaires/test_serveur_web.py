...
from dictionnaire import DictionnaireService, LangueEnum, ResultatValidation, MotDictionnaire
...
class TestAccesSQLiteBasique(unittest.TestCase):
    ...
    def _creer_base_test_francaise(self):
        ...
        # Données de test
        mots_test = [
            ("CHAT", "Mammifère domestique félin", "nom", 9, 1, 4, "C", "T", "A", "CHT", "ODS"),
            ("CHIEN", "Mammifère domestique canin", "nom", 10, 1, 5, "C", "N", "IE", "CHN", "ODS"),
            ("ÊTRE", "Verbe avoir une existence", "verbe", 4, 1, 4, "Ê", "E", "ÊE", "TR", "ODS"),
            ("INEXISTANT", "Mot qui n'existe pas", "nom", 20, 0, 10, "I", "T", "IEIAT", "NXSSTNT", "Test")
        ]
    ...
    def _creer_base_test_anglaise(self):
        ...
        # Données de test
        words_test = [
            ("CAT", "Small domesticated carnivorous mammal", "noun", 5, 1, 3, "C", "T", "A", "CT", "SOWPODS"),
            ("DOG", "Domesticated carnivorous mammal", "noun", 5, 1, 3, "D", "G", "O", "DG", "SOWPODS"),
            ("NONEXISTENT", "Word that does not exist", "noun", 15, 0, 11, "N", "T", "OEEIT", "NNXSSTNT", "Test")
        ]
...
class TestPerformance(unittest.TestCase):
    ...
    def _creer_base_performance_francaise(self):
        ...
        for i in range(1000):  # 1000 mots de test
            mot = f"MOT{i:04d}"
            mots_test.append((
                mot, f"Définition du mot {i}", "nom", 10, 1, 
                len(mot), mot[0], mot[-1], "O", "MT", "Test"
            ))
    ...
    def _creer_base_performance_anglaise(self):
        ...
        for i in range(1000):
            word = f"WORD{i:04d}"
            words_test.append((
                word, f"Definition of word {i}", "noun", 8, 1,
                len(word), word[0], word[-1], "O", "WRD", "Test"
            ))
    ...
    def test_performance_batch_validation(self):
        ...
        self.assertLess(temps_total_ms, 200.0, 
...
class TestCaracteresSpeciaux(unittest.TestCase):
    ...
    def _creer_base_accents_francaise(self):
        ...
        mots_accents = [
            ("ÊTRE", "Verbe d'existence", "verbe", 4, 1, 4, "Ê", "E", "ÊE", "TR", "ODS"),
            ("CŒUR", "Organe de circulation", "nom", 7, 1, 4, "C", "R", "ŒU", "CR", "ODS"),
            ("NAÏF", "Qui manque d'expérience", "adjectif", 7, 1, 4, "N", "F", "AÏ", "NF", "ODS"),
            ("ÉLÈVE", "Personne qui étudie", "nom", 8, 1, 5, "É", "E", "ÉÈE", "LV", "ODS"),
            ("FRANÇAIS", "De France", "adjectif", 14, 1, 8, "F", "S", "AAIÇ", "FRNS", "ODS")
        ]
    ...
    def _creer_base_simple_anglaise(self):
        ...
        words_simple = [
            ("SIMPLE", "Not complex", "adjective", 10, 1, 6, "S", "E", "IE", "SMPL", "SOWPODS")
        ]
