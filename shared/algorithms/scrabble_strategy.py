...
class ScrabbleBoard:
    ...
    def _initialize_board(self) -> List[List[BoardSquare]]:
        ...
        special_squares = {
            # Triple Word Score
            (0, 0): SquareType.TRIPLE_WORD,
            (0, 7): SquareType.TRIPLE_WORD,
            (0, 14): SquareType.TRIPLE_WORD,
            (7, 0): SquareType.TRIPLE_WORD,
            (7, 14): SquareType.TRIPLE_WORD,
            (14, 0): SquareType.TRIPLE_WORD,
            (14, 7): SquareType.TRIPLE_WORD,
            (14, 14): SquareType.TRIPLE_WORD,
            # Double Word Score
            (1, 1): SquareType.DOUBLE_WORD,
            (2, 2): SquareType.DOUBLE_WORD,
            (3, 3): SquareType.DOUBLE_WORD,
            (4, 4): SquareType.DOUBLE_WORD,
            (1, 13): SquareType.DOUBLE_WORD,
            (2, 12): SquareType.DOUBLE_WORD,
            (3, 11): SquareType.DOUBLE_WORD,
            (4, 10): SquareType.DOUBLE_WORD,
            (10, 4): SquareType.DOUBLE_WORD,
            (11, 3): SquareType.DOUBLE_WORD,
            (12, 2): SquareType.DOUBLE_WORD,
            (13, 1): SquareType.DOUBLE_WORD,
            (10, 10): SquareType.DOUBLE_WORD,
            (11, 11): SquareType.DOUBLE_WORD,
            (12, 12): SquareType.DOUBLE_WORD,
            (13, 13): SquareType.DOUBLE_WORD,
            # Center star (Double Word Score)
            (7, 7): SquareType.CENTER,
            # Triple Letter Score
            (1, 5): SquareType.TRIPLE_LETTER,
            (1, 9): SquareType.TRIPLE_LETTER,
            (5, 1): SquareType.TRIPLE_LETTER,
            (5, 5): SquareType.TRIPLE_LETTER,
            (5, 9): SquareType.TRIPLE_LETTER,
            (5, 13): SquareType.TRIPLE_LETTER,
            (9, 1): SquareType.TRIPLE_LETTER,
            (9, 5): SquareType.TRIPLE_LETTER,
            (9, 9): SquareType.TRIPLE_LETTER,
            (9, 13): SquareType.TRIPLE_LETTER,
            (13, 5): SquareType.TRIPLE_LETTER,
            (13, 9): SquareType.TRIPLE_LETTER,
            # Double Letter Score
            (0, 3): SquareType.DOUBLE_LETTER,
            (0, 11): SquareType.DOUBLE_LETTER,
            (2, 6): SquareType.DOUBLE_LETTER,
            (2, 8): SquareType.DOUBLE_LETTER,
            (3, 0): SquareType.DOUBLE_LETTER,
            (3, 7): SquareType.DOUBLE_LETTER,
            (3, 14): SquareType.DOUBLE_LETTER,
            (6, 2): SquareType.DOUBLE_LETTER,
            (6, 6): SquareType.DOUBLE_LETTER,
            (6, 8): SquareType.DOUBLE_LETTER,
            (6, 12): SquareType.DOUBLE_LETTER,
            (7, 3): SquareType.DOUBLE_LETTER,
            (7, 11): SquareType.DOUBLE_LETTER,
            (8, 2): SquareType.DOUBLE_LETTER,
            (8, 6): SquareType.DOUBLE_LETTER,
            (8, 8): SquareType.DOUBLE_LETTER,
            (8, 12): SquareType.DOUBLE_LETTER,
            (11, 0): SquareType.DOUBLE_LETTER,
            (11, 7): SquareType.DOUBLE_LETTER,
            (11, 14): SquareType.DOUBLE_LETTER,
            (12, 6): SquareType.DOUBLE_LETTER,
            (12, 8): SquareType.DOUBLE_LETTER,
            (14, 3): SquareType.DOUBLE_LETTER,
            (14, 11): SquareType.DOUBLE_LETTER,
        }
    ...
    def calculate_word_score(
        ...
        cross_word_score = self._calculate_cross_words_score(word, start_row, start_col, direction, new_tiles)
    ...
    def _can_place_word(self, word: str, start_row: int, start_col: int, direction: Direction) -> bool:
    ...
    def _calculate_cross_words_score(
        self,
        word: str,
        start_row: int,
        start_col: int,
