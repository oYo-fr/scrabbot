...
class DictionaryService:
    ...
    def search_words_by_criteria(self, 
                                   language: LanguageEnum,
                                   length: Optional[int] = None,
                                   starts_with: Optional[str] = None,
                                   ends_with: Optional[str] = None,
                                   limit: int = 100) -> List[DictionaryWord]:
        """
...
class DictionaryConstants:
    ...
    FRENCH_CATEGORIES = ["nom", "verbe", "adjectif", "adverbe", "déterminant", "préposition", "conjonction", "interjection"]
    ENGLISH_CATEGORIES = ["noun", "verb", "adjective", "adverb", "determiner", "preposition", "conjunction", "interjection"]
